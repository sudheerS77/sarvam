  ...
  return (
    <div className="flex items-center justify-center gap-5 my-10">
      {card.map((item) => (
        <div
          key={`${item.name}`}
          className="flex items-center justify-center gap-5 text-lg bg-gray-50 px-7 py-4 border border-gray-200 text-gray-400 shadow-lg rounded-lg hover:bg-gray-300 hover:text-gray-50"
        >
